"""
agents/llm_rep_groq.py
LLM-Rep agent backed by Groq (free tier — llama-3.3-70b-versatile).
"""
...
class LLMRepGroqAgent(BaseAgent):
    """LLM-Rep agent using Groq. Passes reputation score when rep_visible=True."""
